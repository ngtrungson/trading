...
#            hung_canslim(ticker, start, end, realtime = update, source = source, ndays = 1, typetrade = 'Short')
...
#              'MSR', 'MCH', 'TVB', 'TBD']
    analysis_trading(tickers = None, start = "2017-1-2" , end = "2019-3-6", update = False,  source ="ssi")
