...
#            hung_canslim(ticker, start, end, realtime = update, source = source, ndays = 2, typetrade = 'Short')
...
#              'MSR', 'MCH', 'TVB', 'TBD']
    analysis_trading(tickers = None, start = "2017-1-2" , end = "2019-3-11", update = False,  source ="cp68")
